...
public class ChessMatch {
	...
	private void validateSourcePosition(Position position) {
		...
		if (!board.piece(position).isThereAnyPossibleMove())
			throw new ChessException("There are no posible moves for the chosen piece.");
	}
...
//		board.placePiece(new King(board, Color.BLACK), ChessPosition.fromPosition(new Position(7, 7)).toPosition());
